// app/components/pdf/AgreementGenerator.tsx
"use client";
...
import { generatePDF } from "@/app/admin/Agreement/agreementGen";
import { AgreementData } from "@/app/admin/Agreement/AgreementGenerator";
...
const AgreementGenerator: React.FC = () => {
  ...
  const validateForm = () => {
    if (!agreementData.employeeName.trim()) {
      alert("Please enter employee name");
      return false;
    }
    if (!agreementData.jobType) {
